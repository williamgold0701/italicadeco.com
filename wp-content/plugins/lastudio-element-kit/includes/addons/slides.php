...
class LaStudioKit_Slides extends LaStudioKit_Base {
    ...
    protected function render() {
        ...
        foreach ( $settings['slides'] as $slide ) {
            ...
            if ( $slide['subheading'] ) {
                $slide_html .= '<div class="lakit-slide-subheading" data-swiper-parallax="-300">' . $slide['subheading'] . '</div>';
            }

            if ( $slide['heading'] ) {
                $slide_html .= '<div class="lakit-slide-heading"  data-swiper-parallax="-250">' . $slide['heading'] . '</div>';
            }

            if ( $slide['description'] ) {
                $slide_html .= '<div class="lakit-slide-description"  data-swiper-parallax="-200">' . $slide['description'] . '</div>';
            }

            if ( $slide['subdescription1'] ) {
                $slide_html .= '<div class="lakit-slide-subdescription lakit-slide-subdescription1"  data-swiper-parallax="-150">' . $slide['subdescription1'] . '</div>';
            }

            if ( $slide['button_text'] ) {
                $slide_html .= '<' . $btn_element . ' ' . $btn_attributes . ' ' . $this->get_render_attribute_string( 'button' ) . '  data-swiper-parallax="-100">' . $slide['button_text'] . '</' . $btn_element . '>';
            }

            if ( $slide['subdescription2'] ) {
                $slide_html .= '<div class="lakit-slide-subdescription lakit-slide-subdescription2"  data-swiper-parallax="-50">' . $slide['subdescription2'] . '</div>';
            }
            ...
            $slide_bg = '<div class="lakit-slide-wrapbg" data-swiper-parallax="-100">'.$slide_bg.'</div>';
