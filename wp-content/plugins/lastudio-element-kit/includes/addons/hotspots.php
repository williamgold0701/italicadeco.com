...
class LaStudioKit_Hotspots extends Widget_Image {
  ...
  protected function enqueue_addon_resources() {
    if ( ! lastudio_kit_settings()->is_combine_js_css() ) {
      wp_register_script( $this->get_name(), lastudio_kit()->plugin_url( 'assets/js/addons/hotspots.js' ), [ 'elementor-frontend' ], lastudio_kit()->get_version(), true );
  ...
  protected function register_controls() {
    ...
    $repeater->add_control(
      ...
      [
        ...
        'label'       => esc_html__( 'Tooltip Content', 'lastudio-kit' ),
