  ...
  (0, _createClass2.default)(Screenshot, [{
    ...
    value: function getDefaultSettings() {
      return (0, _objectSpread2.default)({
        ...
        excluded_external_css_urls: ['fontawesome.com'],
    ...
    value: function getDefaultElements() {
      ...
      var $sections = $elementor.find('.elementor-section-wrap > .elementor-section, .elementor > .elementor-section, .elementor > .e-container');
      return {
        $elementor: $elementor,
        $sections: $sections,
