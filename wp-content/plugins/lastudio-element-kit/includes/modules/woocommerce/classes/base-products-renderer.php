...
//        \wc_set_loop_prop('is_filtered', \is_filtered());
    ...
    public function add_product_thumbnails_to_loop(){
        ...
        if($enable_alt_image){
            ...
            if($alt_image_as_slide){
                ...
                $output = sprintf('<div class="lakit-embla_wrap"><div class="lakit-embla"><div class="lakit-embla__viewport"><div class="lakit-embla__container">%1$s</div></div></div><div class="lakit-embla-thumb"><div class="lakit-embla__viewport"><div class="lakit-embla__container">%2$s</div></div></div>%3$s</div>', $output, $thumb_output, $arrows);
            }
            else{
    ...
    public function override_wc_pagination(){
        ...
        if($paginate_as_loadmore){
            ...
            $loadmore_html = '<div class="lakit-ajax-loading-outer"><span class="lakit-css-loader"></span></div><div class="lakit-product__loadmore_ajax lakit-pagination_ajax_loadmore"><a href="'.esc_url($current_url).'"><span>'.$load_more_text.'</span></a></div>';
